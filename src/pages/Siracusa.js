  ...
  return(
    <div className="App">
      <div className='container'>
        ...
        <div className='centered-div'>
          <img src={SiracusaAvola} alt="Siracusa Avola" style={{width: '90%', height: 'auto'}} className="responsive-img"/>
          <div className="text-with-bar padding-left-5">
        ...
        <div className='centered-div'>
          <img src={SiracusaPiazza} alt="Siracusa Piazza" style={{width: '90%', height: 'auto'}} className="responsive-img"/>
          <div className="text-with-bar padding-left-5">
        ...
        <div className='centered-div'>
          <img src={SiracusaCat} alt="Siracusa Cat" style={{width: '90%', height: 'auto'}} className="responsive-img"/>
          <div className="text-with-bar padding-left-5">
        ...
        <div className='centered-div'>
          <img src={SiracusaShop} alt="Siracusa Shop" style={{width: '90%', height: 'auto'}} className="responsive-img"/>
          <div className="text-with-bar padding-left-5">
        ...
        <div className='centered-div'>
          <img src={SiracusaSunset} alt="Siracusa Sunset" style={{width: '90%', height: 'auto'}} className="responsive-img"/>
          <div className="text-with-bar padding-left-5">
        ...
        <div className='centered-div'>
          <img src={SiracusaManiace} alt="Siracusa Maniace" style={{width: '90%', height: 'auto'}} className="responsive-img"/>
          <div className="text-with-bar padding-left-5">
