  ...
  return(
    <div className="App">
      <div className='container'>
        ...
        <div className='centered-div'>
          <img src={Tallinn2} alt="Tallinn Vanalinn" style={{width: '90%', height: 'auto'}}/>
          <div className="text-with-bar padding-left-5">
            <div className="color-bar prussia-blue"></div>
        ...
        <div className='centered-div'>
          <img src={TallinnK} alt="Tallinn" style={{width: '90%', height: 'auto'}}/>
          <div className="text-with-bar padding-left-5">
        ...
        <div className='centered-div'>
          <img src={TallinnV} alt="Tallinn" style={{width: '90%', height: 'auto'}}/>
          <div className="text-with-bar padding-left-5">
            <div className="color-bar licorice"></div>
