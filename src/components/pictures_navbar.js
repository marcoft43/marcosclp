    ...
    <Navbar bg="dark" data-bs-theme="dark">
      <Container className="front-navbar">
        <Nav className="custom-nav">
          ...
          <Nav.Link href="/Cannes" className='me-3 navbar-camera'>Cannes</Nav.Link>
          ...
          <Nav.Link href="/Milano" className='me-3 navbar-camera'>Milano</Nav.Link>
          ...
          <Nav.Link href="/Torino" className='me-3 navbar-camera'>Torino</Nav.Link>
